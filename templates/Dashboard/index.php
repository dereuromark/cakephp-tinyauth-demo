...
<div data-style="max-width: 800px; margin: 0 auto; padding: 2rem;">
    <div data-style="background: #e8f5e9; border: 2px solid #4caf50; border-radius: 8px; padding: 1.5rem; margin-bottom: 1.5rem;">
        <h2 data-style="color: #2e7d32; margin-top: 0;">Access Granted</h2>
