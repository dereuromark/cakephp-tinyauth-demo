...
<div data-style="max-width: 800px; margin: 0 auto; padding: 2rem;">
    ...
    <?= $this->Form->create($project) ?>
        <div data-style="margin-bottom: 1rem;">
            <label data-style="display: block; margin-bottom: 0.5rem; font-weight: bold;">Project Name</label>
        ...
        <div data-style="margin-bottom: 1rem;">
            <label data-style="display: block; margin-bottom: 0.5rem; font-weight: bold;">Description</label>
        ...
        <div data-style="margin-bottom: 1rem;">
            <label data-style="display: block; margin-bottom: 0.5rem; font-weight: bold;">Team</label>
        ...
        <div data-style="margin-top: 1.5rem;">
            <?= $this->Form->button('Save Project', [
                'data-style' => 'padding: 0.75rem 1.5rem; background: #9c27b0; color: white; border: none; border-radius: 4px; cursor: pointer; font-size: 1rem;',
            ]) ?>
